...
export const sidebar: DefaultTheme.Sidebar = {
    "/java": [
        {
            ...
            items: [
                ...
                { text: "JDK1.8HashMap源码学习", link: "/java/base/JDK1.8HashMap源码学习" },
        ...
        },
        {
            ...
            collapsed: false,
            items: [
                { text: "ConfigurationProperties注解", link: "/java/framework/ConfigurationProperties注解" },
                {
                ...
                { text: "Mybatis Generator配置", link: "/java/framework/Mybatis Generator配置" },
                {
                    text: "POI事件模式解析并读取Excel文件数据",
                    link: "/java/framework/POI事件模式解析并读取Excel文件数据"
                },
                { text: "Spring Cloud Config接入", link: "/java/framework/Spring Cloud Config接入" },
                { text: "SpringMVC的执行流程源码分析", link: "/java/framework/SpringMVC的执行流程源码分析" },
                { text: "dubbo接口超时配置", link: "/java/framework/dubbo接口超时配置" },
                { text: "logback自定义", link: "/java/framework/logback自定义" },
                { text: "netty+websocket实现即时通讯功能", link: "/java/framework/netty+websocket实现即时通讯功能" },
                {
                    text: "spring-session实现集群session共享",
                    link: "/java/framework/spring-session实现集群session共享"
                },
                { text: "springcloud优雅下线服务", link: "/java/framework/springcloud优雅下线服务" },
                { text: "swagger+knife4j", link: "/java/framework/swagger+knife4j" },
                { text: "使用EasyExcel导出excel", link: "/java/framework/使用EasyExcel导出excel" },
                {
                    text: "使用spring validation进行参数校验",
                    link: "/java/framework/使用spring validation进行参数校验"
                },
                { text: "分布式定时任务解决方案xxl-job", link: "/java/framework/分布式定时任务解决方案xxl-job" },
                { text: "后端允许跨域配置", link: "/java/framework/后端允许跨域配置" },
                { text: "自定义MybatisPlusGenerator", link: "/java/framework/自定义MybatisPlusGenerator" },
                { text: "Spring配置和条件化组件加载注解", link: "/java/framework/Spring配置和条件化组件加载注解" },
            ],
        },
        {
            text: "中间件",
            ...
            items: [
                ...
                { text: "kakfa重复消费问题处理", link: "/java/middleware/kakfa重复消费问题处理" },
                { text: "kafka常用命令记录", link: "/java/middleware/kafka常用命令记录" },
            ],
        },
        {
            text: "数据库",
            ...
            items: [
                ...
                { text: "Otter实现数据全量增量同步", link: "/java/database/Otter实现数据全量增量同步" },
            ],
        },
        {
            text: "工具",
            ...
            items: [
                ...
                { text: "nexus无法下载依赖的问题记录", link: "/java/devtool/nexus无法下载依赖的问题记录" },
            ],
        },
        {
            text: "其他",
            collapsed: false,
            items: [
                { text: "linux服务器安装OpenOffice踩坑", link: "/java/others/linux服务器安装OpenOffice踩坑" },
                { text: "POI踩坑-zip file is closed", link: "/java/others/POI踩坑-zip file is closed" },
                { text: "OpenJDK没有jstack等命令的解决办法", link: "/java/others/OpenJDK没有jstack等命令的解决办法" },
                { text: "微信小程序加密数据对称解密工具类", link: "/java/others/微信小程序加密数据对称解密工具类" },
                {
                    text: "mybatis的classpath配置导致的jar包读取问题",
                    link: "/java/others/mybatis的classpath配置导致的jar包读取问题"
                },
                { text: "feign请求导致的用户ip获取问题记录", link: "/java/others/feign请求导致的用户ip获取问题记录" },
                { text: "ribbon刷新服务列表间隔和canal的坑", link: "/java/others/ribbon刷新服务列表间隔和canal的坑" },
                { text: "cpu占用率高排查思路", link: "/java/others/cpu占用率高排查思路" },
            ],
        },
    ],
    "/python": [
        ...
        },
        {
            ...
            items: [
                ...
                { text: "验证码识别和模拟登录", link: "/python/crawler/验证码识别和模拟登录" },
                { text: "多线程爬取梨视频网站的热门视频", link: "/python/crawler/多线程爬取梨视频网站的热门视频" },
                { text: "selenium模块", link: "/python/crawler/selenium模块" },
                { text: "python配合ffmpeg下载bilibili视频", link: "/python/crawler/python配合ffmpeg下载bilibili视频" },
                { text: "scrapy框架入门", link: "/python/crawler/scrapy框架入门" },
                { text: "scrapy进阶", link: "/python/crawler/scrapy进阶" },
                { text: "CrawlSpider全站爬取", link: "/python/crawler/CrawlSpider全站爬取" },
                { text: "分布式爬虫和增量式爬虫", link: "/python/crawler/分布式爬虫和增量式爬虫" },
                {
        ...
        },
        {
            ...
            items: [
                ...
                { text: "切换windows代理设置开关", link: "/python/others/切换windows代理设置开关" },
                {
                ...
                { text: "读取excel&ssh通道连接rds更新数据", link: "/python/others/读取excel&ssh通道连接rds更新数据" },
                { text: "使用pandas模块进行数据处理", link: "/python/others/使用pandas模块进行数据处理" },
            ],
        },
    ],
    "/golang": [
    ...
    "/linux": [
        ...
        },
        {
            text: "硬件",
            collapsed: false,
            items: [{ text: "linux磁盘操作相关", link: "/linux/hardware/linux磁盘操作相关" }],
        },
    ],
    "/frontend": [
        {
        ...
        },
        {
            ...
            items: [
                ...
                { text: "ElementPlus el-upload源码分析", link: "/frontend/others/ElementPlus el-upload源码分析" },
            ],
        },
    ],
    "/docker": [
        {
            ...
            collapsed: false,
            items: [
                { text: "Dockerfile语法", link: "/docker/Docker/Dockerfile语法" },
                { text: "常用指令", link: "/docker/Docker/常用指令" },
            ],
        },
        {
            text: "Docker Compose",
            collapsed: false,
            items: [{ text: "docker-compose语法", link: "/docker/Docker-compose/docker-compose语法" }],
        },
    ],
    "/actions": [
        {
            ...
            items: [
                ...
                { text: "iterm2配置ssh快速连接", link: "/actions/tools/iterm2配置ssh快速连接" },
                { text: "各系统下校验文件一致性", link: "/actions/tools/各系统下校验文件一致性" },
                { text: "linux设置macOS时间机器server", link: "/actions/tools/linux设置macOS时间机器server" },
                { text: "book-searcher电子书镜像", link: "/actions/tools/book-searcher电子书镜像" },
        ...
        },
        {
            ...
            collapsed: false,
            items: [
                { text: "Windows下Docker Desktop安装", link: "/actions/env/Windows下Docker Desktop安装" },
                {
                    text: "git配置socks5代理解决github上down代码慢的问题",
                    link: "/actions/env/git配置socks5代理解决github上down代码慢的问题"
                },
                { text: "mysql启动报错排查及处理", link: "/actions/env/mysql启动报错排查及处理" },
                { text: "macOS开启终端的代理", link: "/actions/env/macOS开启终端的代理" },
                {
                ...
                { text: "使用github actions进行持续部署", link: "/actions/env/使用github actions进行持续部署" },
                { text: "macos开机自动执行脚本", link: "/actions/env/macos开机自动执行脚本" },
        ...
        },
        {
            ...
            collapsed: false,
            items: [
                { text: "策略模式的具体实现", link: "/actions/designpattern/策略模式的具体实现" },
    ...
    "/tinker": [
        {
            ...
            collapsed: false,
            items: [
                { text: "VMWare虚拟机的几种网络连接模式", link: "/tinker/vm/VMWare虚拟机的几种网络连接模式" },
                { text: "PVE异常关机后磁盘检查处理", link: "/tinker/vm/PVE异常关机后磁盘检查处理" },
                { text: "安装PVE虚拟机并在PVE安装truenas", link: "/tinker/vm/安装PVE虚拟机并在PVE安装truenas" },
            ],
        },
        {
            text: "家庭网络",
            collapsed: false,
            items: [
                { text: "移动光猫改桥接模式", link: "/tinker/network/移动光猫改桥接模式" },
                { text: "家庭服务器home server搭建", link: "/tinker/network/家庭服务器home server搭建" },
                { text: "frp内网穿透", link: "/tinker/network/frp内网穿透" },
                { text: "openwrt安装及配置", link: "/tinker/network/openwrt安装及配置" },
                { text: "windows挂载webdav的问题处理", link: "/tinker/network/windows挂载webdav的问题处理" },
                { text: "pt下载入门", link: "/tinker/network/pt下载入门" },
                { text: "openwrt开启ipv6", link: "/tinker/network/openwrt开启ipv6" },
                { text: "山特ups配合nut实现断电安全关机", link: "/tinker/network/山特ups配合nut实现断电安全关机" },
            ],
        },
    ],
};
