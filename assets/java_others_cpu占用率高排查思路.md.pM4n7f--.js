...
<span class="line"><span>GCT：垃圾回收消耗总时间</span></span></code></pre></div><p>6.<code>jmap -heap pid</code> 查看堆内存详细信息</p><p>7.<code>jmap -histo pid &gt; xxx.log</code> 输出gc日志到文件</p>`,9),c=[t];function o(d,i,l,_,r,u){return p(),s("div",null,c)}const m=a(e,[["render",o]]);export{g as __pageData,m as default};
