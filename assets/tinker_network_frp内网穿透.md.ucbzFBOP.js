...
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">bind_port</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> = 6000</span></span></code></pre></div><p>在需要访问内网的机器上执行命令连接内网服务，例如用户为root</p><p><code>ssh -oPort 6000 root@127.0.0.1</code></p><p>如果内网机器开启了密钥登录，则需要指定内网服务器的私钥文件</p><p><code>ssh -oPort 6000 -i identityFile root@127.0.0.1</code></p>`,17),t=[l];function e(h,k,r,d,c,o){return a(),i("div",null,t)}const y=s(p,[["render",e]]);export{g as __pageData,y as default};
