import{_ as p,c as s,a2 as n,o as e}from"./chunks/framework.BYTlkvxp.js";const h=JSON.parse('{"title":"cpu占用率高排查思路","description":"","frontmatter":{},"headers":[],"relativePath":"java/others/cpu占用率高排查思路.md","filePath":"java/others/cpu占用率高排查思路.md","lastUpdated":1727769398000}'),t={name:"java/others/cpu占用率高排查思路.md"};function c(o,a,d,i,l,r){return e(),s("div",null,a[0]||(a[0]=[n(`<h1 id="cpu占用率高排查思路" tabindex="-1">cpu占用率高排查思路 <a class="header-anchor" href="#cpu占用率高排查思路" aria-label="Permalink to &quot;cpu占用率高排查思路&quot;">​</a></h1><p>1.<code>top</code>命令找出cpu占用率高的进程pid</p><p>2.<code>top -H -p pid</code> 找出cpu占用率高的线程tid</p><p>3.<code>printf &quot;%x&quot; tid</code>命令打印出tid的十六进制形式</p><p>4.<code>jstack pid | grep 十六进制tid -A 行数</code>打印堆栈信息 或者 <code>jstack pid &gt;&gt; log.txt</code>将堆栈信息保存在文件中，再从文件中查找对应线程的信息</p><p>5.<code>jstat -gcutil pid 5000</code> 每隔5秒打印一次gc情况</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>S0：幸存1区当前使用比例</span></span>
